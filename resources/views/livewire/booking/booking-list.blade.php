<div>
    ...
    <x-bpjs.card :pad="false" class="bpjs-rise" style="padding: 16px; margin-bottom: 16px;">
        <div class="flex gap-3 flex-wrap items-end">
            ...
            <x-bpjs.field label="Cari subjek / kode" for="search">
        ...
        @if(count($activeFilters) > 0)
            <div class="flex items-center gap-2 flex-wrap" style="margin-top: 14px;">
                <span style="font-size: 11px; font-weight: 600; text-transform: uppercase; letter-spacing: .05em; color: var(--slate-400);">Filter aktif</span>
                ...
                <button wire:click="clearFilters" type="button" style="background: none; border: 0; font-size: 12px; color: var(--slate-500); font-weight: 600; cursor: pointer;">Hapus semua</button>
            </div>
        @endif
    </x-bpjs.card>
    ...
    <div class="flex items-baseline justify-between" style="margin: 0 4px 10px;">
        <span style="font-size: 12.5px; color: var(--slate-500);">
            <strong style="color: var(--slate-800); font-weight: 700;">{{ $bookings->total() }}</strong> reservasi
        </span>
    </div>
            ...
            <tbody>
                @forelse($bookings as $booking)
                    <tr>
                        ...
                        <td class="text-right">
                            <a href="{{ route('bookings.show', $booking) }}" wire:navigate style="color: var(--bpjs-blue-600); font-weight: 600;">Lihat</a>
                        </td>
                    </tr>
                @empty
                    <tr>
