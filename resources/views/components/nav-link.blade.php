...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-bpjs-blue-500 text-sm font-semibold leading-5 text-slate-900 focus:outline-none focus:border-bpjs-blue-700 transition duration-150 ease-in-out'
