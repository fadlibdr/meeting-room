...
$classes = ($active ?? false)
            ? 'block w-full ps-3 pe-4 py-2 border-l-4 border-bpjs-blue-500 text-start text-base font-semibold text-bpjs-blue-700 bg-bpjs-blue-50 focus:outline-none focus:text-bpjs-blue-800 focus:bg-bpjs-blue-100 focus:border-bpjs-blue-700 transition duration-150 ease-in-out'
